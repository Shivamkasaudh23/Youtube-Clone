...
function SearchPage(props) {
    ...
    useEffect(() => {
        ...
        setVideoRows([]);
        axios
            .get(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&type=channel&q=${searchQuery}&safeSearch=none&key=AIzaSyAqqJWRLBbCEnSR56pgOUXLiNDco_-nmFM`)
            .then(response => {
        ...
        axios
            .get(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=9&type=video&q=${searchQuery}&safeSearch=none&key=AIzaSyAqqJWRLBbCEnSR56pgOUXLiNDco_-nmFM`)
            .then(response => {
    ...
    async function createChannelRow(channel) {
        ...
        const response = await axios
            .get(`https://www.googleapis.com/youtube/v3/channels?part=statistics&id=${channelId}&key=AIzaSyAqqJWRLBbCEnSR56pgOUXLiNDco_-nmFM`)
